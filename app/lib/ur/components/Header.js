...
const ui = {
  ...
  room:  {resource: '/room',  link:'room reservation', iconName: 'date_range'},
  hr:    {resource: '/management', link:'management', iconName: 'contacts'},
...
export default ({ user, signOut, admin }) => {
  ...
  const links = admin ?
    [ui.home, ui.about, ui.room, ui.hr, ui.admin] :
    [ui.home, ui.about, ui.room, ui.hr];
